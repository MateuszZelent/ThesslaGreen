...
class Settings:
    ...
    def from_env(cls, environ: Mapping[str, str] | None = None) -> Settings:
        ...
        return cls(
            ...
            airflow_observation_seconds=float(get("THESSLA_AIRFLOW_OBSERVATION_SECONDS", "0")),
            ...
            command_cache_retention_rows=int(get("THESSLA_COMMAND_CACHE_RETENTION_ROWS", "256")),
            command_cache_ttl_seconds=float(get("THESSLA_COMMAND_CACHE_TTL_SECONDS", "86400")),
        )
