...
from custom_components.thessla_green._core.protocol.transport import ModbusTransport
from custom_components.thessla_green._core.registers import REGISTERS_BY_KEY, RegisterDefinition
...
class AirPackController:
    ...
    async def set_mode(self, mode: AirPackMode | int, *, source: str = "unknown") -> ControlResult:
        try:
