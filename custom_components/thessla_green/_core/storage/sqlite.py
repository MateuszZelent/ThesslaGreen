...
from custom_components.thessla_green._core.domain.models import AuditEvent, DeviceState
...
class SQLiteStore:
    ...
    def _initialize_sync(self) -> None:
        with self._connect() as connection:
            ...
            connection.execute(
                "CREATE INDEX IF NOT EXISTS command_cache_captured_at ON command_cache(captured_at)"
            )
