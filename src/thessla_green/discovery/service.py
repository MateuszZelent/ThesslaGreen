...
from thessla_green.discovery.candidates import SerialPortInfo, enumerate_serial_ports
from thessla_green.discovery.probe import AirPackProbe
...
from thessla_green.protocol.transport import (
    ModbusTransport,
    PymodbusTransport,
    SerialPortBusy,
...
def discovery_endpoints(
    ...
    *,
    ...
    if settings.serial_port:
        ...
        selected_serial_ports = list(serial_ports) if serial_ports is not None else list(
...
class DiscoveryService:
    ...
    async def discover(
        ...
        *,
        ...
        candidates = tuple(endpoints) if endpoints is not None else discovery_endpoints(
            self.settings, serial_ports=serial_ports
        )
