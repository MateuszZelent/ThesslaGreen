...
from thessla_green.application.lease import EndpointLease, EndpointLeaseBusy
from thessla_green.control import ControlIntent, ControlPolicyDecision
...
from thessla_green.storage import EventStore
        ...
        *,
        ...
        async with self._command_lock:
            ...
            if request_id is not None:
                ...
                await self._persist_cached_command(
                    request_id, fingerprint, response, captured_at
                )
